...
def plot_room_utilization(df, output_dir):
    ...
    plt.tight_layout()
    plt.savefig(output_dir / "01_room_utilization.png", dpi=150, bbox_inches="tight")
    plt.close()
...
def plot_fill_ratio(df, output_dir):
    ...
    plt.tight_layout()
    plt.savefig(output_dir / "02_fill_ratio.png", dpi=150, bbox_inches="tight")
    plt.close()
...
def plot_event_distribution(df, output_dir):
    ...
    plt.tight_layout()
    plt.savefig(output_dir / "03_event_distribution.png", dpi=150, bbox_inches="tight")
    plt.close()
    print("  Saved: 03_event_distribution.png")


def plot_busiest_rooms(df, output_dir):
    ...
    plt.tight_layout()
    plt.savefig(output_dir / "04_busiest_rooms.png", dpi=150, bbox_inches="tight")
    plt.close()
    print("  Saved: 04_busiest_rooms.png")


def plot_busiest_modules(df, output_dir):
    ...
    plt.tight_layout()
    plt.savefig(output_dir / "05_busiest_modules.png", dpi=150, bbox_inches="tight")
    plt.close()
    print("  Saved: 05_busiest_modules.png")


def main(df, output_dir="plots"):
    ...
    print("=" * 60)
    generated = sorted(output_dir.glob("0[1-5]_*.png"))
    for f in generated:
        print(f"  - {f.name}")
...
if __name__ == "__main__":
    ...
    main(timetable_df, output_dir=args.output_dir)

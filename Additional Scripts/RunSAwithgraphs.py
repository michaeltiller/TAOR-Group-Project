...
class TimetableImprover:
    ...
    def run_sa(
        ...
        """Run Simulated Annealing. Returns stats dict including cost history."""
        if rng is None:
        ...
        for iteration in range(max_iter):
            ...
            # Log cost at every log_interval iterations
            if iteration % log_interval == 0:
                cost_history.append(self._total_cost_incremental())
...
def plot_convergence(
    ...
    """Plot objective value over SA iterations and save to file."""
    fig, ax = plt.subplots(figsize=(10, 4))
    ax.plot(iterations, cost_history, linewidth=0.8, color="steelblue")
...
def main():
    ...
    parser.add_argument("--log-interval", type=int,   default=100,
                        help="Record objective value every N iterations for convergence plot.")
    ...
    plot_convergence(
        stats["iterations"],
        stats["cost_history"],
        OUT_DIR / f"sa_convergence_{tag}.png",
    )
